...
if { [llength $current_device] == 0 } {
  puts "ERROR: Device $device_name not found. Trying any Artix-7 device..."
...
if { $argc > 0 } {
  ...
  set bitstream_file "./vivado_project/ir_recorder_replay_top.runs/impl_1/ir_recorder_replay_arty_top.bit"
}
