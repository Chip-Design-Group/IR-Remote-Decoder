module ir_recorder_replay_chip_top (busy,
 ...
 sg13g2_buf_1 fanout143 (.A(_0718_),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout144 (.A(\u_core.u_output_formatter.uart_tx_req ),
    .X(net144),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout145 (.A(\u_core.dec_data_valid_i ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout146 (.A(\u_core.tick_us ),
    .X(net146),
    .VDD(VDD),
    .VSS(VSS));
 ...
 sg13g2_buf_1 fanout150 (.A(net151),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout151 (.A(\u_core.u_recorder.state_q[2] ),
    .X(net151),
    .VDD(VDD),
    .VSS(VSS));
 ...
 sg13g2_buf_1 fanout203 (.A(\u_core.pulse_width[11] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout204 (.A(\u_core.pulse_width[10] ),
    .X(net204),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout205 (.A(\u_core.u_pulse_timer.counter[0] ),
    .X(net205),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout206 (.A(\u_core.u_output_formatter.byte_idx[3] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout207 (.A(\u_core.u_output_formatter.byte_idx[2] ),
    .X(net207),
    .VDD(VDD),
    .VSS(VSS));
 ...
 sg13g2_buf_1 fanout209 (.A(\u_core.u_output_formatter.byte_idx[1] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout210 (.A(\u_core.u_output_formatter.byte_idx[1] ),
    .X(net210),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout211 (.A(\u_core.u_output_formatter.byte_idx[0] ),
    .X(net211),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout212 (.A(\u_core.u_output_formatter.byte_idx[0] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout213 (.A(\u_core.u_nec_encoder.us_cnt_q[0] ),
    .X(net213),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout214 (.A(\u_core.enc_mark_active ),
    .X(net214),
    .VDD(VDD),
    .VSS(VSS));
 ...
 sg13g2_buf_1 fanout217 (.A(\u_core.u_nec_encoder.bit_idx_q[0] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout218 (.A(\u_core.u_nec_decoder.current_state[2] ),
    .X(net218),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout219 (.A(\u_core.u_nec_decoder.current_state[0] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout220 (.A(\u_core.record_hold_q ),
    .X(net220),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout221 (.A(\u_core.mem_wr_data[31] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout222 (.A(\u_core.mem_wr_data[30] ),
    .X(net222),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout223 (.A(\u_core.mem_wr_data[29] ),
    .X(net223),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout224 (.A(\u_core.mem_wr_data[28] ),
    .X(net224),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout225 (.A(\u_core.mem_wr_data[27] ),
    .X(net225),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout226 (.A(\u_core.mem_wr_data[26] ),
    .X(net226),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout227 (.A(\u_core.mem_wr_data[25] ),
    .X(net227),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout228 (.A(\u_core.mem_wr_data[24] ),
    .X(net228),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout229 (.A(\u_core.mem_wr_data[23] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout230 (.A(\u_core.mem_wr_data[22] ),
    .X(net230),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout231 (.A(\u_core.mem_wr_data[21] ),
    .X(net231),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout232 (.A(\u_core.mem_wr_data[20] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout233 (.A(\u_core.mem_wr_data[19] ),
    .X(net233),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout234 (.A(\u_core.mem_wr_data[18] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout235 (.A(\u_core.mem_wr_data[17] ),
    .X(net235),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout236 (.A(\u_core.mem_wr_data[16] ),
    .X(net236),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout237 (.A(\u_core.mem_wr_data[15] ),
    .X(net237),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout238 (.A(\u_core.mem_wr_data[14] ),
    .X(net238),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout239 (.A(\u_core.mem_wr_data[13] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout240 (.A(\u_core.mem_wr_data[12] ),
    .X(net240),
    .VDD(VDD),
    .VSS(VSS));
 ...
 sg13g2_buf_1 fanout242 (.A(\u_core.mem_wr_data[10] ),
    ...
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout243 (.A(\u_core.mem_wr_data[9] ),
    .X(net243),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout244 (.A(\u_core.mem_wr_data[8] ),
    .X(net244),
    .VDD(VDD),
    .VSS(VSS));
 sg13g2_buf_1 fanout245 (.A(\u_core.mem_wr_data[0] ),
    .X(net245),
    .VDD(VDD),
    .VSS(VSS));
